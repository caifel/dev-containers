...
The script starts dev-api and dev-web if they are not already running,
waits for dev-api Swagger through the Docker network, then generates
or checks web/src/lib/api/generated/schema.ts.
